...
export const hostCsvColumns = [
  ...
  { label: "Scan File", value: (row) => row.scanFileNames || [row.scanFileName] }
];

export const unreachableHostCsvColumns = [
  { label: "Host Name", value: (row) => row.hostname || row.label || row.ip },
  { label: "IP Address", key: "ip" },
  { label: "Target Label", key: "label" },
  { label: "Status", key: "status" },
...
export const vulnerabilityCsvColumns = [
  ...
  { label: "False Positive", value: (row) => (row.isFalsePositive ? "Yes" : "No") },
  { label: "Scan File", value: (row) => row.scanFileNames || [row.scanFileName] }
];
